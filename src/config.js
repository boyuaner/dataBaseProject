...
module.exports = {
  ...
  footer: '<a target="_blank">我爆打qer</a>版权所有 © 2019-2099',  // footer中显示的字, 可以嵌入html标签
  ...
  api: {  // 对后端请求的相关配置
    host: 'http://118.25.104.28:2018',  // 调用ajax接口的地址, 默认值空, 如果是跨域的, 服务端要支持CORS
    path: '',  // ajax请求的路径
